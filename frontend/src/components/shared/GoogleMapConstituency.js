...
const CONSTITUENCY_COORDS = {
  'new-delhi':         { lat: 28.6139, lng: 77.2090, city: 'New Delhi' },
...
export default function GoogleMapConstituency({ constituencyId, constituencyName }) {
  ...
  if (!apiKey || loadError) {
    return (
      <div style={{
        background: '#f1f5f9', borderRadius: 8, height: 220,
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        flexDirection: 'column', gap: 8, color: '#64748b'
      }}>
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
          <path d="M14 3C9.582 3 6 6.582 6 11c0 8.167 8 16 8 16s8-7.833 8-16c0-4.418-3.582-8-8-8z"
