...
const firebaseConfig = {
  ...
  authDomain:        process.env.REACT_APP_FIREBASE_AUTH_DOMAIN || 'votesmart-ai-voting-companion.firebaseapp.com',
  projectId:         process.env.REACT_APP_FIREBASE_PROJECT_ID || 'votesmart-ai-voting-companion',
  storageBucket:     process.env.REACT_APP_FIREBASE_STORAGE_BUCKET || 'votesmart-ai-voting-companion.appspot.com',
...
export const analyticsEvents = {
  ...
  journeyStarted:    (voterType, location) => trackEvent('journey_started', { voter_type: voterType, location }),
  ...
  constituencyViewed:(name, state) => trackEvent('constituency_viewed', { constituency: name, state }),
