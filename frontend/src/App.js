...
function PageLoader() {
  return (
    <div style={{
      ...
      minHeight: 'calc(100vh - 60px)', flexDirection: 'column', gap: 16
    }}>
        ...
        <main>
          ...
          <Routes>
            ...
            <Route path="/journey" element={
              <ErrorBoundary><Suspense fallback={<PageLoader />}><Journey /></Suspense></ErrorBoundary>
            } />
            <Route path="/simulation" element={
              <ErrorBoundary><Suspense fallback={<PageLoader />}><Simulation /></Suspense></ErrorBoundary>
            } />
            <Route path="/constituency" element={
              <ErrorBoundary><Suspense fallback={<PageLoader />}><Constituency /></Suspense></ErrorBoundary>
            } />
            <Route path="/chat" element={
              <ErrorBoundary><Suspense fallback={<PageLoader />}><Chat /></Suspense></ErrorBoundary>
            } />
            <Route path="/mythbuster" element={
              <ErrorBoundary><Suspense fallback={<PageLoader />}><MythBuster /></Suspense></ErrorBoundary>
            } />
            {/* 404 fallback */}
            <Route path="*" element={
              <div style={{
