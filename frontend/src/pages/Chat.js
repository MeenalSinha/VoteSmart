...
export default function Chat() {
  ...
  useEffect(() => {
    chatAPI
      .getSuggestions(userContext.language)
            ...
            <div className="chat-header-actions">
              ...
              >
                <svg aria-hidden="true" width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <path
                    d="M2 4h10M5 4V2.5h4V4M6 7v3M8 7v3M3 4l.75 7.5h6.5L11 4"
                    stroke="currentColor"
                    strokeWidth="1.3"
                    strokeLinecap="round"
          ...
          <div className="chat-window">
                ...
                {messages.map((msg, i) => (
                  ...
                  >
                    {msg.role === 'assistant' && (
                      <div className="chat-message__avatar" aria-hidden="true">
                        ...
                        >
                          ...
                          <path
                            d="M2.5 12c0-2.485 2.015-4.5 4.5-4.5s4.5 2.015 4.5 4.5"
                            stroke="white"
                            strokeWidth="1.2"
                            strokeLinecap="round"
                          />
                    ...
                    <div className="chat-message__content">
                      <p>{msg.content}</p>
                      <div
                        className="chat-message__time text-xs"
            ...
            {messages.length <= 1 && suggestions.length > 0 && (
              <div className="chat-suggestions">
                <div className="chat-suggestions__label text-xs text-muted">
                  {t('chat.suggested')}
                </div>
            ...
            <div className="chat-input-area">
              ...
              <p className="chat-disclaimer text-xs text-muted">
                AI responses are for informational purposes only. For official information, visit
                the{' '}
                <a
              ...
              <div className="chat-context-items">
                ...
                <div className="chat-context-item">
                  ...
                  <span className="text-small">
                    {userContext.voterType?.replace('-', ' ') || 'Not set'}
                  </span>
                </div>
                <div className="chat-context-item">
                  <span className="text-xs text-muted">Language</span>
                  <span className="text-small">
                    {userContext.language === 'hi' ? 'Hindi' : 'English'}
                  </span>
                </div>
                {voiceSupported && (
                  <div className="chat-context-item">
                    ...
                    <span
                      className="text-small badge badge-green"
