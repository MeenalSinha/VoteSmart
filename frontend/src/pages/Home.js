...
const features = [
  {
    ...
    description: 'Personalized step-by-step guide from registration to polling day, tailored to your location and voter type.',
    path: '/journey',
    cta: 'Begin journey'
  },
  {
    ...
    description: 'Practice election day scenarios with branching decisions. Learn what to do when things go wrong.',
    path: '/simulation',
    cta: 'Run simulation'
  },
  {
    icon: (
      <svg aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M3 14l4-8 3 5 2-3 4 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
    title: 'Constituency Insights',
    description: 'Historical election data, turnout trends, and AI-generated analysis for your constituency.',
    path: '/constituency',
    cta: 'Explore data'
  },
  {
    ...
    description: 'Ask anything about elections in plain language. Factual, non-partisan answers in English or Hindi.',
    path: '/chat',
    cta: 'Ask a question'
  },
  {
    ...
    title: 'MythBuster',
    description: 'Paste any election claim and get an instant AI verdict — True, False, or Misleading — with sources.',
    path: '/mythbuster',
...
const demoSteps = [
  { num: '01', title: 'Enter your location', desc: 'Select India, your state, and constituency', path: '/journey' },
  { num: '02', title: 'Get your personalized guide', desc: 'AI generates a 4-step voter journey just for you', path: '/journey' },
  { num: '03', title: 'Download your checklist', desc: 'Save a PDF with all documents and steps', path: '/journey' },
  { num: '04', title: 'Practice with simulation', desc: 'Navigate real election day scenarios', path: '/simulation' },
  { num: '05', title: 'Explore constituency data', desc: 'View historical results and AI insights', path: '/constituency' },
  { num: '06', title: 'Ask the AI coach', desc: 'Get instant answers in English or Hindi', path: '/chat' },
];
        ...
        <div className="container">
          <motion.div className="home__hero-content" {...fadeUp(0)}>
            ...
            <p className="home__hero-desc">
              VoteSmart combines AI, real constituency data, and interactive simulations
              to help every Indian voter participate with confidence.
            </p>
            ...
            <div className="home__hero-card card">
              ...
              <div className="home__checklist">
                {['Voter ID Card', 'Aadhaar Card', 'Polling Slip'].map((item, i) => (
                  <div key={item} className={`home__checklist-item ${i < 2 ? 'home__checklist-item--done' : ''}`}>
              ...
              <div className="home__hero-ai-note">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  ...
                  <path d="M7 4v4M7 9.5v.5" stroke="var(--color-accent)" strokeWidth="1.2" strokeLinecap="round"/>
                </svg>
      ...
      <section className="home__demo">
        <div className="container">
          <div className="home__section-header">
            ...
            <p className="text-muted">Follow this flow to experience every feature of VoteSmart in under 5 minutes.</p>
          </div>
          <div className="home__demo-grid">
            {demoSteps.map((step, i) => (
              ...
              >
                ...
                <svg className="home__demo-arrow" width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </motion.div>
            ))}
      ...
      <section className="home__features">
        <div className="container">
          <div className="home__section-header">
            ...
            <p className="text-muted">Five integrated tools guiding you from registration to the polling booth and beyond.</p>
          </div>
      ...
      <section className="home__cta-section">
        <div className="container">
          <div className="home__cta-banner">
            ...
            <p className="text-muted">Start with your personalized voter journey. Takes less than 2 minutes to set up.</p>
